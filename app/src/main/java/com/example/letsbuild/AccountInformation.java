...
public class AccountInformation extends AppCompatActivity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        docId= new ArrayList<>();
        productView=(GridView) findViewById(R.id.accountList);
        ...
        productView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                Account_Adapter adapter = new Account_Adapter(AccountInformation.this,products);

                UserInfo p1 =(UserInfo) adapter.getItem(i);
                Intent intent = new Intent(AccountInformation.this,Account_Details.class)

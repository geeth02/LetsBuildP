...
public class Admin_Pending_Ads extends AppCompatActivity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        setContentView(R.layout.activity_admin_pending_ads);
        firebaseFirestore = FirebaseFirestore.getInstance();
        products= new ArrayList<>();
        docId= new ArrayList<>();
        productView=(GridView) findViewById(R.id.admin_pending_list);
        ...
        productView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ProductAdapter adapter = new ProductAdapter(Admin_Pending_Ads.this,products);

                Product p1 =(Product) adapter.getItem(i);
                Intent intent = new Intent(Admin_Pending_Ads.this, Admin_Appoved_Ads.class)

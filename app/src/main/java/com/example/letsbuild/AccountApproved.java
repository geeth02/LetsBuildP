...
public class AccountApproved extends AppCompatActivity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        setContentView(R.layout.activity_account_approved);
        firebaseFirestore = FirebaseFirestore.getInstance();
        products= new ArrayList<>();
        docId= new ArrayList<>();
        productView=(GridView) findViewById(R.id.accountAppList);
        ...
        productView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                Account_Adapter adapter = new Account_Adapter(AccountApproved.this,products);

                UserInfo p1 =(UserInfo) adapter.getItem(i);
                Intent intent = new Intent(AccountApproved.this,Account_Details_App.class)

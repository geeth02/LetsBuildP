...
public class View_Tiling extends AppCompatActivity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        productView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ProductAdapter adapter = new ProductAdapter(View_Tiling.this,products);

                Product p1 =(Product) adapter.getItem(i);
                Intent intent = new Intent(View_Tiling.this, Pending_Ads_Details.class)

...
public class Member_Delete_Ads extends AppCompatActivity {
    ImageView image;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_member_delete_ads);
        ...
        if(intent.getExtras()!=null){
            ...
            Glide.with(Member_Delete_Ads.this).load(photoUri).into(image);
                    ...
                    dbroot.collection(category)
                            ...
                            .addOnSuccessListener(new OnSuccessListener() {
                                ...
                                public void onSuccess(Object o) {
                                    Toast.makeText(Member_Delete_Ads.this, "Delete successfully!", Toast.LENGTH_LONG).show();
                                }
                            });
                }
            });

...
public class Admin_Decline_Ads extends AppCompatActivity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        setContentView(R.layout.activity_admin_decline_ads);
        firebaseFirestore = FirebaseFirestore.getInstance();
        products= new ArrayList<>();
        docId= new ArrayList<>();
        productView=(GridView) findViewById(R.id.decline_list);
        ...
        productView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ProductAdapter adapter = new ProductAdapter(Admin_Decline_Ads.this,products);

                Product p1 =(Product) adapter.getItem(i);
                Intent intent = new Intent(Admin_Decline_Ads.this, Pending_Ads_Details.class)

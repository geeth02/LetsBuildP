...
public class View_Civiling extends AppCompatActivity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        setContentView(R.layout.activity_view_civiling);
        ...
        productView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ProductAdapter adapter = new ProductAdapter(View_Civiling.this,products);

                Product p1 =(Product) adapter.getItem(i);
                Intent intent = new Intent(View_Civiling.this, Pending_Ads_Details.class)

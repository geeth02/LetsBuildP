...
public class My_Ads extends AppCompatActivity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        docId= new ArrayList<>();
        productView=(GridView) findViewById(R.id.admin_Ads);
        ...
        productView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ProductAdapter adapter = new ProductAdapter(My_Ads.this,products);

                Product p1 =(Product) adapter.getItem(i);
                Intent intent = new Intent(My_Ads.this, Pending_Ads_Details.class)

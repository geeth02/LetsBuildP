...
public class View_Roofing extends AppCompatActivity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        setContentView(R.layout.activity_view_roofing);
        ...
        productView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ProductAdapter adapter = new ProductAdapter(View_Roofing.this,products);

                Product p1 =(Product) adapter.getItem(i);
                Intent intent = new Intent(View_Roofing.this, Pending_Ads_Details.class)
